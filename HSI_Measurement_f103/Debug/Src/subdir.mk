...
C_SRCS += \
../Src/hsi_measurement.c \
../Src/syscalls.c \
../Src/sysmem.c 

OBJS += \
./Src/hsi_measurement.o \
./Src/syscalls.o \
./Src/sysmem.o 

C_DEPS += \
./Src/hsi_measurement.d \
./Src/syscalls.d \
./Src/sysmem.d 


# Each subdirectory must supply rules for building sources it contributes
Src/hsi_measurement.o: ../Src/hsi_measurement.c Src/subdir.mk
	arm-none-eabi-gcc "$<" -mcpu=cortex-m3 -std=gnu11 -g3 -DDEBUG -DSTM32 -DSTM32F1 -DSTM32F103C8Tx -c -I../Inc -O0 -ffunction-sections -fdata-sections -Wall -fstack-usage -MMD -MP -MF"Src/hsi_measurement.d" -MT"$@" --specs=nano.specs -mfloat-abi=soft -mthumb -o "$@"
