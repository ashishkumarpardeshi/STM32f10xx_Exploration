 ...
 * @brief             - This function will initialize the USART as per User Configurable items.
 ...
 *
 * @brief             - This function will enable or disable USARTx peripheral clock
 *
 * @param[in]         - pUSARTx  (USARTx Address)
 * @param[in]         - EnOrDi	 (Clock Enable or Disable)
 *
 * @return            - None
 *
 * @Note              -
...
/*******************************************************************************************
 * @fn      		  - USART_SetBuadRate
 *
 * @brief             - This function will set desired USARTx Baud Rate
 *
 * @param[in]         - pUSARTx  	(USARTx Address)
 ...
 * @brief             - This API will enable or disable the USART
 ...
 * @brief             - This API will get the Flag status of USARTx

 * @param[in]         - *pUSARTx  (USARTx Address)
 * @param[in]         -  StatusFlagName	  (Flag name)
 ...
 * @brief             - This API will send data via USART Tx pin.

 * @param[in]         - *pUSARTx  (USARTx Address)
 * @param[in]         - *pTxBuffer (Hold Data to be transmitted)
 * @param[in]         - Len		  (Length of the transmitting Data)
 ...
 *
 * @brief             - This API will receive data via USART Rx Line

 * @param[in]         - *pUSARTx  (USARTx Address)
 * @param[in]         - *pRxBuffer (Hold Data to be Recieved)
 * @param[in]         - Len		  (Length of the Recieved Data)
 *
 * @return            -
 *
 * @Note              -
