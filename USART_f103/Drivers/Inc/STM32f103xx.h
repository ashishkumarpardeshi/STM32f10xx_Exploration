...
#include <stdint.h>
 ...
 #define TIM2_BASEADDR			(APB1PERIPH_BASEADDR + 0x00000000U)	// Base address of TIM2
 #define TIM3_BASEADDR			(APB1PERIPH_BASEADDR + 0x00000400U)	// Base address of TIM3
 #define TIM4_BASEADDR			(APB1PERIPH_BASEADDR + 0x00000800U)	// Base address of TIM4
 #define RTC_BASEADDR			(APB1PERIPH_BASEADDR + 0x00002800U)	// Base address of RTC
 #define WWDG_BASEADDR			(APB1PERIPH_BASEADDR + 0x00002C00U)	// Base address of WWDG
 #define IWDG_BASEADDR			(APB1PERIPH_BASEADDR + 0x00003000U)	// Base address of IWDG
 #define SPI2_BASEADDR			(APB1PERIPH_BASEADDR + 0x00003800U)	// Base address of SPI2
 #define USART2_BASEADDR		(APB1PERIPH_BASEADDR + 0x00004400U)	// Base address of USART2
 #define USART3_BASEADDR		(APB1PERIPH_BASEADDR + 0x00004800U)	// Base address of USART2
 #define I2C1_BASEADDR			(APB1PERIPH_BASEADDR + 0x00005400U)	// Base address of I2C1
 #define I2C2_BASEADDR			(APB1PERIPH_BASEADDR + 0x00005800U)	// Base address of I2C2
 #define USB_BASEADDR			(APB1PERIPH_BASEADDR + 0x00005C00U)	// Base address of USB
 #define USB_CAN_SH_BASEADDR	(APB1PERIPH_BASEADDR + 0x00006000U)	// Base address of USB_CAN
 #define BXCAN_BASEADDR			(APB1PERIPH_BASEADDR + 0x00006400U)	// Base address of bxCAN
 #define BKP_BASEADDR			(APB1PERIPH_BASEADDR + 0x00006C00U)	// Base address of BKP
 #define PWR_BASEADDR			(APB1PERIPH_BASEADDR + 0x00007000U)	// Base address of PWR
...
//Note: Registers of a peripheral are specific to MCU
 ...
 /*
  * Reset and Clock Control (RCC) registers definition structure
  */
typedef struct
{
...
/*
 * RCC base addresses type casted to RCC_RegDef_t
 */
#define RCC						((RCC_RegDef_t*) RCC_BASEADDR)

/*
 * GPIOs base addresses type casted to GPIO_RegDef_t
 */
...
/*
 * USARTs base addresses type casted to USART_RegDef_t
 */
